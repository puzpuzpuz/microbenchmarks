...
custom UTF-8 serialization for   100B with UTF-8 chars x 1,761,194 ops/sec ±1.32% (93 runs sampled)
standard UTF-8 serialization for 100B with UTF-8 chars x 1,867,045 ops/sec ±1.11% (93 runs sampled)
...
custom UTF-8 serialization for   1024B with UTF-8 chars x   218,856 ops/sec ±1.53% (93 runs sampled)
standard UTF-8 serialization for 1024B with UTF-8 chars x   298,843 ops/sec ±2.22% (90 runs sampled)
...
custom UTF-8 serialization for   10240B with UTF-8 chars x  22,887 ops/sec ±1.28% (95 runs sampled)
standard UTF-8 serialization for 10240B with UTF-8 chars x  26,477 ops/sec ±1.71% (89 runs sampled)
...
custom UTF-8 serialization for   102400B with UTF-8 chars x  2,336 ops/sec ±0.49% (93 runs sampled)
standard UTF-8 serialization for 102400B with UTF-8 chars x  2,670 ops/sec ±1.37% (92 runs sampled)
```
...
custom UTF-8 deserialization for   100B with UTF-8 chars x  1,093,390 ops/sec ±1.08% (91 runs sampled)
standard UTF-8 deserialization for 100B with UTF-8 chars x  1,311,610 ops/sec ±1.56% (91 runs sampled)
...
custom UTF-8 deserialization for   1024B with UTF-8 chars x   102,269 ops/sec ±1.63% (88 runs sampled)
standard UTF-8 deserialization for 1024B with UTF-8 chars x   102,166 ops/sec ±1.40% (90 runs sampled)
...
custom UTF-8 deserialization for   10240B with UTF-8 chars x   9,191 ops/sec ±1.45% (85 runs sampled)
standard UTF-8 deserialization for 10240B with UTF-8 chars x   8,163 ops/sec ±1.19% (93 runs sampled)
...
custom UTF-8 deserialization for   102400B with UTF-8 chars x    613 ops/sec ±1.50% (83 runs sampled)
standard UTF-8 deserialization for 102400B with UTF-8 chars x    794 ops/sec ±1.16% (91 runs sampled)
```
